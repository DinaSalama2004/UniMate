  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        interactive: "border-border shadow-md hover:shadow-xl hover:border-primary/20 hover:-translate-y-1 cursor-pointer",
        ai: "border-accent/20 bg-accent-light shadow-md hover:shadow-ai-glow",
